...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/barba.js":[function(require,module,exports) {
...
function g(t, n) {
  for (var r, i = [], e = 0, o = 0, u = "", s = n && n.delimiter || y, f = n && n.whitelist || void 0, c = !1; null !== (r = P.exec(t));) {
    var a = r[0],
        h = r[1],
        v = r.index;
    if (u += t.slice(o, v), o = v + a.length, h) u += h[1], c = !0;else {
      ...
      if (!c && u.length) {
        var b = u.length - 1,
            g = u[b];
        (!f || f.indexOf(g) > -1) && (l = g, u = u.slice(0, b));
      }
...
function E(t, n) {
  return function (r, i) {
    ...
    for (var o = e[0], u = e.index, s = {}, f = i && i.decode || decodeURIComponent, c = 1; c < e.length; c++) {
      if (void 0 !== e[c]) {
        var a = n[c - 1];
        s[a.name] = a.repeat ? e[c].split(a.delimiter).map(function (t) {
          return f(t, a);
        }) : f(e[c], a);
      }
    }
...
function x(t, n) {
  for (var r = new Array(t.length), i = 0; i < t.length; i++) {
    "object" == _typeof(t[i]) && (r[i] = new RegExp("^(?:" + t[i].pattern + ")$", R(n)));
  }

  return function (n, i) {
    for (var e = "", o = i && i.encode || encodeURIComponent, u = !i || !1 !== i.validate, s = 0; s < t.length; s++) {
      var f = t[s];
      ...
      if ("string" != typeof f) {
        ...
        if (Array.isArray(a)) {
          ...
          for (var h = 0; h < a.length; h++) {
            if (c = o(a[h], f), u && !r[s].test(c)) throw new TypeError('Expected all "' + f.name + '" to match "' + f.pattern + '"');
            e += (0 === h ? f.prefix : f.delimiter) + c;
          }
        } else if ("string" != typeof a && "number" != typeof a && "boolean" != typeof a) {
          if (!f.optional) throw new TypeError('Expected "' + f.name + '" to be ' + (f.repeat ? "an array" : "a string"));
        } else {
          if (c = o(String(a), f), u && !r[s].test(c)) throw new TypeError('Expected "' + f.name + '" to match "' + f.pattern + '", but got "' + c + '"');
          e += f.prefix + c;
        }
      } else e += f;
    }
...
function T(t, n, r) {
  for (var i = (r = r || {}).strict, e = !1 !== r.start, o = !1 !== r.end, u = r.delimiter || y, s = [].concat(r.endsWith || []).map(k).concat("$").join("|"), f = e ? "^" : "", c = 0; c < t.length; c++) {
    var a = t[c];
    if ("string" == typeof a) f += k(a);else {
      var h = a.repeat ? "(?:" + a.pattern + ")(?:" + k(a.delimiter) + "(?:" + a.pattern + "))*" : a.pattern;
      n && n.push(a), f += a.optional ? a.prefix ? "(?:" + k(a.prefix) + "(" + h + "))?" : "(" + h + ")?" : k(a.prefix) + "(" + h + ")";
    }
  }

  if (o) i || (f += "(?:" + k(u) + ")?"), f += "$" === s ? "$" : "(?=" + s + ")";else {
    var v = t[t.length - 1],
        l = "string" == typeof v ? v[v.length - 1] === u : void 0 === v;
    i || (f += "(?:" + k(u) + "(?=" + s + "))?"), l || (f += "(?=" + k(u) + "|" + s + ")");
  }
  return new RegExp(f, R(r));
}
...
d.match = function (t, n) {
  var r = [];
  return E(O(t, r, n), r);
}, d.regexpToFunction = m, d.parse = w, d.compile = function (t, n) {
  return x(g(t, n), n);
...
var S = {
  ...
  return n.toString = function (t) {
    ...
    if (e.href = arguments[0], 1 === i) return e.href;
    var o = document.getElementsByTagName("head")[0];
    o.insertBefore(e, o.firstChild);

    for (var u, s = document.createElement("a"), f = 1; f < i; f++) {
      s.href = arguments[f], e.href = u = s.href;
    }

    return o.removeChild(e), u;
  }, n.s = function (t, n) {
  ...
  return i.init = function (t, n) {
    ...
    if (r && r.state) {
      var i = r.state,
          e = i.index;
      n = this.m(this.v - e), this.replace(i.states), this.v = e;
    } else this.add(t, n);
  ...
  try {
    var r = function () {
      if (!n.next.html) return Promise.resolve(t).then(function (t) {
        ...
        if (t) {
          var i = j.toElement(t);
          r.namespace = j.getNamespace(i), r.container = j.getContainer(i), r.html = t, M.update({
            ns: r.namespace
          });
          var e = j.toDocument(t);
  ...
  var f = o.indexOf("?");
  return f >= 0 && (u = D(o.slice(f + 1)), o = o.slice(0, f)), {
    hash: e,
    path: o,
    port: n,
    query: u
...
var X = new (function (t) {
  ...
  return r.init = function () {
    ...
    for (var n = this, r = arguments.length, i = new Array(r > 1 ? r - 1 : 0), e = 1; e < r; e++) {
      i[e - 1] = arguments[e];
    }
  ...
  function n(r, i) {
    ...
    for (var o = arguments.length, u = new Array(o > 2 ? o - 2 : 0), s = 2; s < o; s++) {
      u[s - 2] = arguments[s];
    }

    return (e = t.call.apply(t, [this].concat(u)) || this).error = r, e.label = i, Error.captureStackTrace && Error.captureStackTrace(function (t) {
      if (void 0 === t) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
      return t;
    }(e), n), e.name = "BarbaError", e;
  }
  ...
  return n.add = function (t, n) {
    ...
    var e = new Map(),
      ...
      var o = !0,
          u = {};
      return !(!n.self || "self" !== i.name) || (r.A.reverse().forEach(function (n) {
        o && (o = r.R(i, n, t, u), i.from && i.to && (o = r.R(i, n, t, u, "from") && r.R(i, n, t, u, "to")), i.from && !i.to && (o = r.R(i, n, t, u, "from")), !i.from && i.to && (o = r.R(i, n, t, u, "to")));
      }), e.set(i, u), o);
    }),
        u = e.get(o),
        s = [];
    ...
    t.priority = 0;
    var r = 0;
    return this.A.forEach(function (i, e) {
      r += n.O(t, i.name, e + 1);
    }), t.priority = r, t;
  }, t;
}(),
  ...
  return r.get = function (t, n) {
    ...
    try {
      ...
      e.S = !0;
      var u = f(function () {
        return Promise.resolve(e.j("beforeOnce", n, o)).then(function () {
          return Promise.resolve(e.once(n, o)).then(function () {
            return Promise.resolve(e.j("afterOnce", n, o)).then(function () {});
          });
        });
      }, function (t) {
        e.S = !1, e.logger.debug("Transition error [before/after/once]"), e.logger.error(t);
      });
    ...
    try {
      ...
      var h = f(function () {
        function t() {
          return Promise.resolve(s.j("before", n, c)).then(function () {
            var t = !1;

            function r(r) {
              return t ? r : Promise.resolve(s.remove(n)).then(function () {
                return Promise.resolve(s.j("after", n, c)).then(function () {});
              });
            }

            var o = function () {
              if (a) return f(function () {
                return Promise.resolve(s.add(n, e)).then(function () {
                  return Promise.resolve(s.j("beforeLeave", n, c)).then(function () {
                    return Promise.resolve(s.j("beforeEnter", n, c)).then(function () {
                      return Promise.resolve(Promise.all([s.leave(n, c), s.enter(n, c)])).then(function () {
                        return Promise.resolve(s.j("afterLeave", n, c)).then(function () {
                          return Promise.resolve(s.j("afterEnter", n, c)).then(function () {});
                        });
                      });
                    });
                  });
              ...
              var r = function r(_r) {
                return t ? _r : f(function () {
                  var t = function () {
                    if (!1 !== o) return Promise.resolve(s.add(n, e)).then(function () {
                      return Promise.resolve(s.j("beforeEnter", n, c)).then(function () {
                        return Promise.resolve(s.enter(n, c, o)).then(function () {
                          return Promise.resolve(s.j("afterEnter", n, c)).then(function () {});
                        });
                      });
                    });
                  ...
                  u = f(function () {
                return Promise.resolve(s.j("beforeLeave", n, c)).then(function () {
                  return Promise.resolve(Promise.all([s.leave(n, c), L(i, n)]).then(function (t) {
                    return t[0];
                  })).then(function (t) {
                    return o = t, Promise.resolve(s.j("afterLeave", n, c)).then(function () {});
                  });
                });
              }, function (t) {
        ...
        var r = function () {
          if (a) return Promise.resolve(L(i, n)).then(function () {});
        }();
...
var ft = {
  ...
  return i.use = function (t, n) {
    ...
    var n = void 0 === t ? {} : t,
        ...
        g = n.debug,
        E = n.logLevel;
    if (l.setLevel(!0 === (void 0 !== g && g) ? "debug" : void 0 === E ? "off" : E), this.logger.info(this.version), Object.keys(f).forEach(function (t) {
      S[t] && (S[t] = f[t]);
    }), this.$ = c, this.timeout = h, this.cacheIgnore = d, this.prefetchIgnore = w, this.preventRunning = b, this._ = this.dom.getWrapper(), !this._) throw new Error("[@barba/core] No Barba wrapper found");
    this._.setAttribute("aria-live", "polite"), this.q();
    var x = this.data.current;
    if (!x.container) throw new Error("[@barba/core] No Barba container found");

    if (this.cache = new G(d), this.prevent = new it(w), this.transitions = new ut(e), this.views = new st(u), null !== P) {
    ...
    try {
      ...
      return Promise.resolve(s && s.then ? s.then(e) : e());
    } catch (t) {
      return Promise.reject(t);
    }
    ...
    var e = r[0],
        o = r[1],
        u = this.cache.getAction(e);
    return this.cache.delete(e), !(this.$ && !1 === this.$(t, u, e, o) || ("click" === u && this.force(e), 1));
    ...
    if (r) {
      ...
      this.prevent.checkHref(i) || this.cache.has(i) || this.cache.set(i, this.request(i, this.timeout, this.onRequestError.bind(this, r)).catch(function (t) {
        n.logger.error(t);
      }), "enter");
    }
  }, i.U = function (t) {
...
},{}]},{},["../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/barba.js"], null)
//# sourceMappingURL=/barba.06918169.js.map